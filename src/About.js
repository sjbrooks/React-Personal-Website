...
function About() {
  ...
  const paragraphs = [
    ...
    <strong>From that came a reinvigorated interest in engineering, and specifically programming, as a means of understanding how the things we interact with every day are built.</strong>,
    'Last year, I decided to make a career change based on that interest, and I’ve been coding daily since. I\'m passionate about expanding the representation of women in tech and look forward to being able to use my skills for social impact.',
